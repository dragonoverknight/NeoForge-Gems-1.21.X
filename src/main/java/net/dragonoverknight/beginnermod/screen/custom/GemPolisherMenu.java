package net.dragonoverknight.beginnermod.screen.custom;
...
public class GemPolisherMenu extends AbstractContainerMenu {
    ...
    public GemPolisherMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity = ((GemPolisherBlockEntity) entity);
    ...
    private static final int TE_VANILLA_FIRST_SLOT_INDEX = VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT;
    ...
    public ItemStack quickMoveStack(Player playerIn, int pIndex) {
        ...
        if (pIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            if (!moveItemStackTo(sourceStack, TE_VANILLA_FIRST_SLOT_INDEX, TE_VANILLA_FIRST_SLOT_INDEX + TE_INVENTORY_SLOT_COUNT, false)) {
